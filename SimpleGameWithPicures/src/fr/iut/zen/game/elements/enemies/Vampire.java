...
public class Vampire implements Mobs {

	private final String VampirePATH = "pictures/Vampire.png";
	private final GridPosition locationVampire;
	private final double DropCardChance = 0.55;
	private final double DropEquipmentChance = 0.45;
	private final double baseHealth = 18;
	private final double baseDamage = 5.8;
